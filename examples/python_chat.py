#!/usr/bin/env python3
"""Claude Opus 5 (claude-opus-5) client: non-streaming, streaming and tool calling."""
...
def chat(prompt: str, model: str = "claude-opus-5", **extra) -> dict:
...
def stream(prompt: str, model: str = "claude-opus-5"):
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Claude Opus 5 chat client")
