#!/usr/bin/env python3
"""Refresh Claude Opus 5 token pricing from the public pricing payload.
...
TARGETS = [t for t in ("claude-opus-5", "") if t]
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Refresh Claude Opus 5 pricing")
